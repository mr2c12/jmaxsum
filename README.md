...
The experiments with the DSA algorithm has been run via the [`exp/dsa.sh`](https://github.com/mr2c12/jmaxsum/blob/dsa/exp/dsa.sh) script.
The experiments with the Max-Sum algorithm has been run via the [`exp/maxsum.sh`](https://github.com/mr2c12/jmaxsum/blob/dsa/exp/maxsum.sh) script.
