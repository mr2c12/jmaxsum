...
public class PGCreator implements Runnable{
    ...
    int numberOfGenerators; int numberOfLoadsForGenerator; int R; double xmean; double delta;
    HashSet<Generator> generators;
    HashSet<Load> loads;
    boolean isAlive;

    public PGCreator(int numberOfGenerators, int numberOfLoadsForGenerator, int R, double xmean, double delta, HashSet<Generator> generators, HashSet<Load> loads) {
